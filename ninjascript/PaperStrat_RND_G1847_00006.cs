...
{
	/// <summary>
	/// RND-G1847-00006 — Mean Reversion | NQ | 1H
	/// Entry: RSI(13) < 45 AND Close < BB_Lower(11,2) AND ADX(14) < 30
	/// Exit:  RSI(13) > 50 OR Close > BB_Mid(11)
	/// Exit Engine: 5% profit trigger → trailing stop (25% giveback)
	/// </summary>
	public class PaperStrat_RND_G1847_00006 : Strategy
	{
		private RSI rsi;
		...
		private const string STRAT_NAME = "RND-G1847-00006";

		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				Description = "RND-G1847-00006 — Mean Reversion NQ 1H (Paper)";
				Name = "PaperStrat_RND_G1847_00006";
