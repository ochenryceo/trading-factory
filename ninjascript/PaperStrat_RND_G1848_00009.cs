...
{
	/// <summary>
	/// RND-G1848-00009 — Mean Reversion | NQ | 1H
	/// Entry: RSI(5) < 40 AND Close < BB_Lower(10,2) AND ADX(14) < 30
	/// Exit:  RSI(5) > 50 OR Close > BB_Mid(10)
	/// Exit Engine: 5% profit trigger → trailing stop (25% giveback)
	/// </summary>
	public class PaperStrat_RND_G1848_00009 : Strategy
	{
		private RSI rsi;
		...
		private const string STRAT_NAME = "RND-G1848-00009";

		protected override void OnStateChange()
		{
			if (State == State.SetDefaults)
			{
				Description = "RND-G1848-00009 — Mean Reversion NQ 1H (Paper)";
				Name = "PaperStrat_RND_G1848_00009";
